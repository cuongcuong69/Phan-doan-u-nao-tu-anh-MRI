# -*- coding: utf-8 -*-
"""
Visualize kết quả dự đoán UNETR 3D trên BraTS2020:
...
CFG_VIS: Dict[str, Any] = {
    ...
    "NUM_SLICES": 6,
    "FIXED_SLICES": [],  # Ví dụ: [70, 80, 90] hoặc [] để tự động chọn

    # Đường dẫn tương đối (theo ROOT)
    "DATA_ROOT_3D": "data/processed/3d/labeled",
    "PRED_ROOT": "experiments/brats3d_unetr_full/inference/preds",
    "OUT_DIR": "experiments/brats3d_unetr_full/vis",
...
# =============================================================================
# ROOT - Adjusted for colab_project directory
# =============================================================================
